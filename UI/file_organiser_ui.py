...
class Ui_file_organiser(object):
    def setupUi(self, file_organiser):
        ...
        self.hl_buttons.addWidget(self.pb_add)

        self.pb_browse = QPushButton(self.frame)
        self.pb_browse.setObjectName(u"pb_browse")

        self.hl_buttons.addWidget(self.pb_browse)

        self.pb_organise = QPushButton(self.frame)
        self.pb_organise.setObjectName(u"pb_organise")

        self.hl_buttons.addWidget(self.pb_organise)


        self.gridLayout.addLayout(self.hl_buttons, 2, 0, 1, 1)
        ...
        self.menubar.setGeometry(QRect(0, 0, 487, 23))
    ...
    def retranslateUi(self, file_organiser):
        ...
        self.pb_add.setText(QCoreApplication.translate("file_organiser", u"Add", None))
